...
2. **helper**:
   * **apicall.helper.js**: to call the third party form we use the same function we use to expose API call helper.js folder
   ...
   * **other.helper.js**: common function which is necessary for this codebase are there

3. **middleware:**
   * **authentication.middleware.js**: use for the API authentication and authorization

4. **module:** The structure of module folder(e.g.Content module).
...
7. **index.js**: it’s the server entry point

8. **app.js**: app related function are implemented here
